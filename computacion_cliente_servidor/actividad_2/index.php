    ...
    <body>
        ...
        <section class="principal">
            ...
            <form method="post" action="confirmacion_envio.php">  
                ...
                <input id="name" name="name" placeholder="Nombre" onblur="toUpperCaseInput()">
                ...
                <input id="email" name="email" type="mail" placeholder="Correo electrónico" onblur="validateEmailPreviously()">
